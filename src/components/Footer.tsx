        ...
        >
          <div className="space-y-8">
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Secure Crypto Exchange</p>
              </div>
            </div>
            <p className="text-sm leading-6 text-gray-300">
              Leading cryptocurrency exchange platform providing secure, fast, and anonymous trading
              of 900+ digital assets worldwide.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              >
                <h3 className="text-sm font-semibold leading-6 text-white">Trading</h3>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <motion.div
                ...
                className="mt-10 md:mt-0"
              >
                <h3 className="text-sm font-semibold leading-6 text-white">Legal & Security</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        >
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <p className="text-xs leading-5 text-gray-400">
              &copy; 2025 NOHVEX. All rights reserved. Licensed and regulated cryptocurrency exchange platform.
            </p>
